...
export const LeadAdd = () => {
  ...
  return (
    <div className="container-fluid">
      <h5 className="p-3 border-bottom text-center">Add New Lead</h5>

      <Sidebar backTo={ROUTES.DASHBOARD} backLabel="Back to Dashboard">
        <div className="card">
          <div className="card-body">
            <h6 className="card-title mb-4">Lead Details</h6>
              ...
              <div className="row g-3">
                ...
                <div className="col-12">
                  <label className="form-label">
                    Tags <span className="text-muted small">(hold Ctrl/Cmd to select multiple)</span>
                  </label>
